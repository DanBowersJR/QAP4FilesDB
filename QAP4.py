...
# Data Formating, use FormatValues.py
...
# Print outputs
    print(f"Customer name: {FirstName:<5s} {LastName:<5s}")
...
# Optional: Create a file and write the policy data to it, then print out a success message. Close file!
